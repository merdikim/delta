...
const Navbar = () => {
  ...
  return (
    <>
      <div className="flex h-(--navbar-height) w-full items-center justify-between border-b-2 border-b-slate-200 px-4 sm:px-6">
        <Link to="/home">
          <img
      ...
      {isProfileOpen ? (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/45 px-4 py-6 backdrop-blur-sm">
          <div className="w-full max-w-sm rounded-[1.75rem] border border-white/70 bg-white p-5 shadow-[0_24px_80px_rgba(15,23,42,0.18)] sm:p-6">
