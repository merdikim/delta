      ...
      <div className="w-full max-w-lg rounded-4xl border border-white/70 bg-white/90 p-6 shadow-[0_24px_80px_rgba(15,23,42,0.24)] sm:p-7">
        ...
        <div className="mt-5 text-center">
          ...
          <p className="mt-2 text-sm leading-6 text-slate-600">
            We&apos;re confirming the deposit transaction, then updating your
            goal with the new contribution.
          </p>
        </div>
        ...
        <div className="mt-6 space-y-3">
          ...
          />
          <PendingStep
            label="Updating goal in database"
            description="Once the transaction hash is available, we save the deposit against this goal."
